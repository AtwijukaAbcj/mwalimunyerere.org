...
$event_query = $con->prepare("SELECT * FROM blogs WHERE id = ?");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update query
    $update_query = $con->prepare("UPDATE blogs SET title = ?, description = ?, overview = ?, event_date = ?, event_time = ?, location = ?, ticket_price = ?, contact_number = ?, category = ?, additional_info = ? WHERE id = ?");
