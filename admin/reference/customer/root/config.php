...
defined ("APP_DIR") or define("APP_DIR","customer");
...
$uc_list = array('Sales Agent','Administrator','Customer');
switch(DB_URL){
	case 'localhost':
		defined ("DB_SERVER") or define("DB_SERVER", 'localhost');
		defined ("DB_USER") or define("DB_USER", "root");
		defined ("DB_PASS") or define("DB_PASS", "");
		defined ("DB_NAME") or define("DB_NAME", "centric_customer_db");
		defined ("SITE_URL") or define("SITE_URL", BASE_URL.'/'.APP_DIR.'/');
		defined("HOME_URL") or define("HOME_URL", SITE_URL.'home');
	break;
	case 'https://abc.com/': //when its running online 
		defined ("DB_SERVER") or define("DB_SERVER", 'localhost');
...
function get_reference(){
	$result = rand(11111111,9999999);
	return $result;
}

function get_customers(){
	global $dbh;
	$result = $dbh->query("SELECT COUNT(*) FROM users WHERE role ='Customer'")->fetchColumn();
	return $result;
}

function get_agents(){
	global $dbh;
	$result = $dbh->query("SELECT COUNT(*) FROM users WHERE role='Sales Agent'")->fetchColumn();
	return $result;
}

function get_pharmacies(){
	global $dbh;
	$result = $dbh->query("SELECT COUNT(*) FROM pharmacy ")->fetchColumn();
	return $result;
}

function get_products(){
	global $dbh;
	$result = $dbh->query("SELECT COUNT(*) FROM products ")->fetchColumn();
	return $result;
}

function get_contacts(){
	global $dbh;
	$result = $dbh->query("SELECT COUNT(*) FROM users ")->fetchColumn();
	return $result;
}
