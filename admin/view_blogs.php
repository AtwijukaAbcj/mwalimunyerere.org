        ...
        <div class="col-md-10">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <?php
                    // Fetch all events
                    $sql = "SELECT * FROM blogs ORDER BY event_date DESC";
                    $result = mysqli_query($con, $sql);

                    // Check if query executed successfully
                    if (!$result) {
                        echo "<div class='alert alert-danger'>Error fetching blogs: " . mysqli_error($con) . "</div>";
                                ...
                                while ($event = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="edit_blogs.php?id=<?php echo $event['id']; ?>" class="btn btn-warning btn-sm me-2">
